...
public:
	 ...
	 * @param _mainw is the window on which this textfield will be
	 * @param _x,_y are the positions where this textfield will be
	 * @param _w,_h are the dimensions of the textfield
	 * @param _ID ist he ID of this textfield
	 ...
	 */
	CTextField(CWindow* _mainw, int _x, int _y, int _w, int _h, DWORD _ID, const wchar_t* _statText = NULL, int _stw = 0);
